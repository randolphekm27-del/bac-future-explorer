...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 grid w-full max-w-lg gap-4 border bg-background p-6 shadow-lg duration-200 sm:rounded-lg overflow-hidden flex flex-col",
        "left-[max(1rem,calc(50%-min(calc(100vw-2rem),32rem)/2)]",
        "top-[max(1rem,calc(50%-min(calc(100vh-2rem),var(--dialog-height))/2)]",
